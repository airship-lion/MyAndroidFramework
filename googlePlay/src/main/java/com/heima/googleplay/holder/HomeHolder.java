...
import com.heima.googleplay.widget.ProgressArc;
...
public class HomeHolder extends BaseHolder<AppInfo> implements OnClickListener {
	...
	public void setData(AppInfo data) {
		...
		DownloadInfo downloadInfo = mDownloadManager.getDownInfo(data.getId());
	...
	public void refreshView() {
		...
		Glide.with(UIUtils.getContext())
				.load(HttpHelper.URL + "image?name=" + appInfo.getIconUrl())
				.into(item_icon);
